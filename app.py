...
def find_associatio_rule(support):
  ...
  model = pickle.load(open('C:/Users/POORNIMA/aprioriexample.pkl','rb'))
  dataset=pd.read_csv("C:/Users/POORNIMA/retail_dataset.csv")    
  #Create list 
  transactions = []
...
if st.button("About"):
  st.subheader("Developed by Himanshi khandelwal")
html_temp = """
